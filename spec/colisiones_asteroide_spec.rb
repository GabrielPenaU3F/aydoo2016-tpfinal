...
describe 'Colisiones del asteroide' do
  ...
  it 'el asteroide chocado deberia aplicarse efecto nulo al ser chocado por otro asteroide' do
  ...
  #Asteroide-estrella
  it 'el asteroide deberia aplicarse efecto nulo al chocar con una estrella' do
